...
TEST_F(ConvexHullTest, OrientationTest){
    ...
    EXPECT_EQ(xpoly_utilities::orientation(points[0],points[1],points[2]), 19);
    EXPECT_EQ(xpoly_utilities::orientation(points[3], points[2], points[0]), -6);
    EXPECT_EQ(xpoly_utilities::orientation(points[4],points[5],points[6]), -1);
}
