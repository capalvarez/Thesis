...
#r_points, r_segments, r_polygons, r_limits = read_file("TBeam_region.txt")
points, segments, polygons, limits = read_file("fem_eq_mesh.txt")
...
#button3 = Button(frame, text="Clear", command=lambda: canvas.erasing("all"))
